...
public static class Program
{
    ...
    {
        Console.WriteLine("! This is the app, that does not work.");
        ...
        await using (var context = new MyDbContext())
        {
            ...
            var tenant = new TenantEntity { Id = new Models.PlatformTenantId(Guid.NewGuid()), Name = "Tenant" };
            var user = new UserEntity { Id = new Models.PlatformUserId(Guid.NewGuid()), Name = "User" };
